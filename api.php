<?php
	...
	*/
	...
	/** 
	 * executeOrderCase method passes the order details required to place an order.   
	 * 
	 * @return $response
	 */
	function executeOrderCase(){
		global $method, $data, $caseId;
		$order = new Order($caseId, $method, $data);
		$response = $order->executeAction();
		return $response;
	}
?>