<?php
	...
	require_once __DIR__ . '/../dao/UserAddressDao.php';

	/**
	 * @author Ramu Ramasamy
	 * @version 1.0
	 */
	class UserAddress extends Honey{
		...
		/**
		 * getAddress method is used to fetch address of a particular user by using DAO.
		 * 
		 * @return $response;
		 */
		private function getAddress(){
			...
			$response = $userAddressDao->getAddress($this->inputDataMap);
